...
const HelpSection = () => {
   return (
      <section className='mt-20 relative h-[400px] overflow-clip'>
         <div>
         ...
         <div className='absolute z-20 inset-0 flex flex-col items-center justify-center '>
            <h2 className='text-white text-center text-6xl font-medium not-italic'>
               Still Need Help Deciding?
            </h2>
            <p className='text-white font-normal text-xl mt-5 not-italic'>
